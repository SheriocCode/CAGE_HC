...
class SwinTransformerV2(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 use_checkpoint=False, pretrained_window_sizes=[0, 0, 0, 0],dilation=False,frozen_stages=-1, out_indices=(0, 1, 2, 3), **kwargs):
        super().__init__()
...
#     model = build_swin_transformerV2('swin_L_384_22k', 384, dilation=True)
